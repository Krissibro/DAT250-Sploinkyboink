...
\noindent We will now give an overview over our frontend. The frontend is responsible for displaying the backend as a UI (user interface). \\ \\
...
\node[class, node distance=1.5cm] (Features) {Features};
