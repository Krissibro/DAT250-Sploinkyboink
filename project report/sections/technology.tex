...
\begin{tcolorbox}[colframe=blue!80!black, colback=blue!5!white, coltitle=blue!50!black, title={-}, boxrule=0.5mm, width=0.8\textwidth]
    \begin{itemize}
        \item \textbf{\tiny Kotlin} (\tiny Data class):
        \begin{lstlisting}[style=kotlin, basicstyle=\tiny\ttfamily]
data class Person(val name: String, val age: Int)
        \end{lstlisting}
        
        \item \textbf{\tiny Java} (\tiny Full class):
...
\begin{tcolorbox}[colframe=blue!80!black, colback=blue!5!white, coltitle=blue!50!black, title={-}, boxrule=0.5mm, width=0.8\textwidth, sharp corners=south]
    \begin{itemize}
        \item \textbf{\tiny Kotlin} (\tiny Null safety):
        \begin{lstlisting}[style=kotlin, basicstyle=\tiny\ttfamily]
...
greet(null)  // Output: Hello, Guest!
        ...
        \item \textbf{\tiny Java} (\tiny Manual null check):
        \begin{lstlisting}[style=java, basicstyle=\tiny\ttfamily]
...
\begin{tcolorbox}[colframe=blue!80!black, colback=blue!5!white, coltitle=blue!50!black, title={-}, boxrule=0.5mm, width=0.8\textwidth, sharp corners=south]
    \begin{itemize}
        \item \textbf{\tiny Kotlin} (\tiny Null Coroutines):
        \begin{lstlisting}[style=kotlin, basicstyle=\tiny\ttfamily]
...
fun main() = runBlocking {
    launch { fetchData() }
        ...
        \item \textbf{\tiny Java} (\tiny Threads):
        \begin{lstlisting}[style=java, basicstyle=\tiny\ttfamily]
public class Main {
...
\begin{tcolorbox}[colframe=blue!80!black, colback=blue!5!white, coltitle=blue!50!black, title={-}, boxrule=0.5mm, width=0.8\textwidth, sharp corners=south]
    \begin{itemize}
        \item \textbf{\tiny Kotlin} (\tiny Using Extension Functions):
        \begin{lstlisting}[style=kotlin, basicstyle=\tiny\ttfamily]
...
fun main() {
    ...
    println(text.capitalizeFirstLetter())  // Output: "Kotlin is fun"
        ...
        \item \textbf{\tiny Java} \tiny (Using a Utility Class):
        \begin{lstlisting}[style=java, basicstyle=\tiny\ttfamily]
